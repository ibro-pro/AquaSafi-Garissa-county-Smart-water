...
const WorkingHome = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => animateCounter(setWaterPoints, 287), 500);
    setTimeout(() => animateCounter(setReports, 1567), 600);
    setTimeout(() => animateCounter(setCommunities, 50), 700);
    setTimeout(() => animateCounter(setPartners, 12), 800);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {principles.map((item, index) => (
              <div
                key={index}
                className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border border-cyan-100 hover:-translate-y-1"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {programs.map((program, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-300 group hover:-translate-y-1"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="text-center group hover:-translate-y-1 transition duration-300"
              >
      ...
      <section id="community" className="py-20 bg-cyan-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="bg-white text-cyan-700 p-8 rounded-xl shadow-lg max-w-md mx-auto">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-gray-50 p-8 rounded-xl shadow-lg border border-cyan-100 hover:shadow-xl transition duration-300"
              >
