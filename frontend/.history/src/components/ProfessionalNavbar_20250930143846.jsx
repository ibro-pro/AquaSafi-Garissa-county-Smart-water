          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-3">
              ...
              <motion.button
                ...
                className="bg-gradient-to-r from-cyan-600 to-emerald-600 text-white px-6 py-2 rounded-lg font-semibold hover:from-cyan-700 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
