...
const LoginPopup = ({ isOpen, onClose, initialTab = 'login' }) => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      // Close modal and navigate to dashboard after successful login
      setTimeout(() => {
        onClose();
        setSuccess(false);
        navigate('/dashboard');
  ...
  const handleSignupSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      // Close modal and navigate to dashboard after successful signup
      setTimeout(() => {
        onClose();
        setSuccess(false);
        navigate('/dashboard');
                  ...
                  <AnimatePresence mode="wait">
                    {activeTab === 'login' ? (
                      ...
                      >
                        ...
                        <form onSubmit={handleSignupSubmit} className="space-y-4 pb-8">
                          {/* Name Fields */}
